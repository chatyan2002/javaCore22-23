...
public interface Commands {
    ...
    static void printCommands() {
        ...
        System.out.println("Please input " + SEARCH_DOCTOR_BY_PROFESSION + " for search doctor by frofession");
        System.out.println("Please input " + DELETE_DOCTOR_BY_ID + " for delete doctor by id");
        System.out.println("Please input " + CHANGE_DOCTOR_BY_ID + " for change doctor data by id");
